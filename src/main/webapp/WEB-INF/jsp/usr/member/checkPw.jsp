        ...
        <form action="../member/doCheckPw" method="POST">
            <table class="w-full table-auto text-sm">
                ...
                <tr class="border-t">
                    ...
                    <td class="px-4 py-2">
                        <c:choose>
                            <c:when test="${rq.loginedMember.socialMember}">
                                <span class="text-gray-500">소셜 로그인 사용자입니다. 아래 확인 버튼을 눌러 진행해 주세요.</span>
                                <input type="hidden" name="loginPw" value="SOCIAL_MEMBER_PLACEHOLDER"/>
                            </c:when>
                            <c:otherwise>
